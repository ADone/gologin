...
Package `gologin` provides Go handlers for the Facebook OAuth2 Authorization flow and for obtaining the Facebook [User struct](https://github.com/ADone/gologin/blob/master/facebook/verify.go).

### Getting Started

    go get github.com/ADone/gologin/facebook
    cd $GOPATH/src/github.com/ADone/gologin/examples/facebook
    go get .
